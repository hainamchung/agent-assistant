...
- **Codex Wiki Skills**: Added missing `wiki` command skills (`wiki`, `wiki:auto`, `wiki:fast`, `wiki:hard`, `wiki:team`) for the Codex Assistant.
...
### Revert
- **Realizing**
  - Simple info is more better than detail for ai agent. Make AI agent free power to can make thinking better.

## [3.0.0] - 2026-05-01

### **Try to make more info** -> Test adapt if define clearly.

/**
 * Qwen platform installer/uninstaller.
 */
...
function installQwen() {
    ...
    // 1.1 Global Config Files (QWEN.md, AGENT.md)
...
module.exports = { installQwen, uninstallQwen };

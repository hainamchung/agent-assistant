# Agent Assistant — Kiro Orchestrator

> **MANDATORY BOOT SEQUENCE** — EXECUTE BEFORE ANY OTHER ACTION
>
> 1. **READ NOW**: `~/.kiro/skills/agent-assistant/rules/CORE.md`
...
```
COMMANDS = ~/.kiro/skills/agent-assistant/commands/
...
**NOW: Read `~/.kiro/skills/agent-assistant/rules/CORE.md` before proceeding.**

...
|-----------|-------------|--------|
| Scope exceeds plan capacity (> 10 phases) | `project-manager` | Break into milestones, prioritize, create project roadmap |
| Cross-team dependencies unclear | `project-manager` | Map stakeholder dependencies, define handoff protocol |
| Risk assessment needs business context | `business-analyst` | Business impact analysis and risk prioritization |

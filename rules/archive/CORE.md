...
### EMBODY Exception (Standard Execution)

When EMBODYing an agent via Standard Execution, you **temporarily become** that agent.
...
| **Embodiment** | Standard Execution activates | Follow agent's full protocol |
| **Return** | Agent EXIT | Automatic return to Coordination |

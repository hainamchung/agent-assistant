...
const FEATURES_ITEMS: NavItem[] = [
  ...
  { label: 'Benchmarks & Scorecard', href: '/features/benchmarks' },
  { label: 'Execution Topologies', href: '/features/topologies' },
  { label: 'Security & Trust', href: '/features/security-trust' },
]
